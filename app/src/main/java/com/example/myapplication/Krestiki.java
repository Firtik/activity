...
public class Krestiki extends AppCompatActivity {
    String name1;
    String name2;
    int count = 0;
    TextView textField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_krestiki);
    ...
    public void checkWinner(){
        ...
        if(button1.getText()=="X" & button2.getText() == "X" & button3.getText() == "X"){
            textField.setText("Победитель: "+name1);
            ...
            count = 0;
            Toast toast = Toast.makeText(this, "Победитель: "+name1,Toast.LENGTH_LONG);
            toast.show();
        }
            ...
            textField.setText("Победитель: "+name2);
            button1.setClickable(false);
            button2.setClickable(false);
            button3.setClickable(false);
            button4.setClickable(false);
            ...
            button9.setClickable(false);
            count = 0;
            Toast toast = Toast.makeText(this, "Победитель: "+name2,Toast.LENGTH_LONG);
            toast.show();
        }
